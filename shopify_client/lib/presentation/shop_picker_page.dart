...
class _ShopPickerPageState extends State<ShopPickerPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ShopPickerBloc>(
      create: (context) => getIt<ShopPickerBloc>()
        ..add(ShopPickerEvent.radiusChanged(radius: radius)),
      child: BlocConsumer<ShopPickerBloc, ShopPickerState>(
        ...
        builder: (context, state) => BlocListener<LocationBloc, LocationState>(
            listenWhen: (previous, current) {
              if (previous.location != current.location) {
                context.read<ShopPickerBloc>().add(
                    ShopPickerEvent.locationChanged(
              ...
              if (previous.radius != current.radius) {
                context
                    .read<ShopPickerBloc>()
                    .add(ShopPickerEvent.radiusChanged(radius: current.radius));
                return true;
              }
              return false;
            },
