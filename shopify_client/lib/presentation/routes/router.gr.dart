...
import 'package:shopify_domain/shop.dart' as _i10;
...
class AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    DebugShopRoute.name: (routeData) {
      ...
      return _i8.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i3.DebugShopPage(key: args.key, shop: args.shop));
    },
  ...
  List<_i8.RouteConfig> get routes => [
        _i8.RouteConfig(AuthWrapperRoute.name, path: '/', children: [
        ...
        _i8.RouteConfig(DebugShopRoute.name, path: '/debug-shop-page')
      ];
}
