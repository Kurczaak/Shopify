...
import 'package:shopify_domain/core/location/shopify_location_facade.dart'
    as _i8;
import 'package:shopify_domain/core/network/network_info.dart' as _i13;
...
import 'application/shop_watcher/shop_watcher_bloc.dart' as _i15;
...
import 'infrastructure/product/product_repository_implementation.dart' as _i12;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i12.ProductRepositoryImpl>(() => _i12.ProductRepositoryImpl(
      networkInfo: get<_i13.NetworkInfo>(),
      firestore: get<_i14.FirebaseFirestore>()));
  gh.factory<_i15.ShopWatcherBloc>(() => _i15.ShopWatcherBloc(
      get<_i9.IShopRepository>(), get<_i6.ILocationFacade>()));
  gh.lazySingleton<_i16.AuthBloc>(() => _i16.AuthBloc(get<_i3.IAuthFacade>()));
  gh.factory<_i17.SignInFormBloc>(
      () => _i17.SignInFormBloc(get<_i3.IAuthFacade>(), get<_i16.AuthBloc>()));
  return get;
}
