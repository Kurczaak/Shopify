...
import 'package:shopify_client/domain/auth/auth_failure.dart' as _i6;
import 'package:shopify_client/domain/auth/i_auth_facade.dart' as _i3;
import 'package:shopify_client/domain/auth/user.dart' as _i5;
import 'package:shopify_client/domain/auth/value_objects.dart' as _i7;
...
class MockIAuthFacade extends _i1.Mock implements _i3.IAuthFacade {
  ...
  _i4.Future<_i2.Either<_i6.AuthFailure, _i2.Unit>> signInWithGoogle() =>
      (super.noSuchMethod(Invocation.method(#signInWithGoogle, []),
          ...
          as _i4.Future<_i2.Either<_i6.AuthFailure, _i2.Unit>>);
  @override
  _i4.Future<void> singOut() =>
      (super.noSuchMethod(Invocation.method(#singOut, []),
