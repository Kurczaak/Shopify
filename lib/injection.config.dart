...
import 'application/shopping/shopping_actor/shopping_actor_bloc.dart' as _i10;
import 'application/shopping/shopping_watcher/shopping_watcher_bloc.dart'
    as _i11;
import 'domain/auth/i_auth_facade.dart' as _i5;
import 'domain/shopping/i_shop_repository.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i7.IShopRepository>(
      () => _i8.ShopRepository(get<_i9.FirebaseFirestore>()));
  gh.factory<_i10.ShoppingActorBloc>(
      () => _i10.ShoppingActorBloc(get<_i7.IShopRepository>()));
  gh.factory<_i11.ShoppingWatcherBloc>(
      () => _i11.ShoppingWatcherBloc(get<_i7.IShopRepository>()));
