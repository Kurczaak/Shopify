...
class _$_Product extends _Product {
  ...
  @override
  String toString() {
    return 'ProductForm(id: $id, barcode: $barcode, weight: $weight, nutrientFacts: $nutrientFacts, category: $category, name: $name, brand: $brand, description: $description, ingredients: $ingredients, photos: $photos)';
  }
