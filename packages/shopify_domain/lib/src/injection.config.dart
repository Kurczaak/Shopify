...
import 'package:algolia/algolia.dart' as _i27;
...
import '../product/shopify_product_searcher.dart' as _i25;
import '../shop.dart' as _i28;
import 'auth/firebase_auth_facade.dart' as _i20;
import 'cart/firebase_cart_facade_impl.dart' as _i22;
import 'core/images/image_picker_injectable_module.dart' as _i32;
import 'core/images/image_picker_photo_picker_implementation.dart' as _i18;
import 'core/injectable_module.dart' as _i30;
import 'core/location/location_injectable_module.dart' as _i33;
import 'core/location/shopify_location_facade_implementation.dart' as _i23;
import 'product/algolia_product_searcher_impl.dart' as _i26;
import 'product/barcode_scanner/mobile_scanner_barcode_scanner_facade_impl.dart'
    as _i4;
import 'product/firebase_product_repository.dart' as _i24;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i17.ShopifyLocationFacade>(() =>
      _i23.ShopifyLocationFacadeImpl(
          get<_i13.Location>(), get<_i8.GeocodingPlatform>()));
  gh.lazySingleton<_i3.ShopifyProductRepository>(() =>
      _i24.FirebaseProductRepositoryImpl(
          firestore: get<_i6.FirebaseFirestore>(),
          storage: get<_i7.FirebaseStorage>(),
          networkInfo: get<_i15.NetworkInfo>()));
  gh.factory<_i25.ShopifyProductSearcher>(() => _i26.AlgoliaProductSearcher(
      algolia: get<_i27.Algolia>(), networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i28.ShopifyShopRepository>(() =>
      _i29.FirebaseShopRepositoryImpl(get<_i6.FirebaseFirestore>(),
...
class _$LocationInjectableModule extends _i33.LocationInjectableModule {}
